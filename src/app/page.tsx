        ...
        <section className="relative flex min-h-[75vh] items-center justify-center overflow-hidden border-b border-border bg-white px-6 py-16 sm:py-24">
          ...
          <div className="relative mx-auto max-w-4xl space-y-4 text-center">
            ...
            <p className="text-base text-muted-foreground sm:text-lg">
              Покажем прототип за несколько дней, соберём понятный интерфейс, настроим сборку и выкладку, подключим аналитику.
              Используем стек React/TypeScript/Tailwind/shadcn/ui, готовим к трафику за 2–6 недель.
            </p>
            <Button
              asChild
